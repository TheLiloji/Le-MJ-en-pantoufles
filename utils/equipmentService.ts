...
import equipmentData  from '../assets/equipements_dnd.json';
import magicItemsData from '../assets/objets_magiques_dnd_fr.json';
import poisonsData from '../assets/poisons_dnd_fr.json';
